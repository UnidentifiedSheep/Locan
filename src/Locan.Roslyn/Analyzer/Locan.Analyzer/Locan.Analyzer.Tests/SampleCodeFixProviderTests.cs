...
using Xunit;
using Verifier =
	Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<Locan.Analyzer.SampleSyntaxAnalyzer,
		Locan.Analyzer.SampleCodeFixProvider>;

namespace Locan.Analyzer.Tests;
