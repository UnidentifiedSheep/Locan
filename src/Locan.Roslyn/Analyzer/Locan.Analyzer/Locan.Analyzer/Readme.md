...
### Locan.Analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Locan.Analyzer.Sample.csproj](../Locan.Analyzer.Sample/Locan.Analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Locan.Analyzer.Tests
